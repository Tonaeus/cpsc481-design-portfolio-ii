...
The project includes the following main user interfaces:

### General Access
* Home: Landing page
* Account: Sign-in and sign-up page
* Forgot Password: Account recovery page
* Browse: Book search page
* Book: Book information page

### Patron Access
* Reserve: Book reservation page
* Reservation Details: Reservation information page
* Dashboard: Overview page
* History: Transaction history page
* Pay Fees: Payment page
* Report: Lost or damaged book reporting page
...
* **Tony Tran** – tony.tran4@ucalgary.ca
* **Yousef Hammad** – yousef.hammad1@ucalgary.ca
* **Eric Mei** – eric.mei@ucalgary.ca
* **Angelo Troncone** – angelo.troncone@ucalgary.ca